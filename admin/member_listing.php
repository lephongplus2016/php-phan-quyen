...
if (!empty($_SESSION['current_user'])) {
	...
	// đảm bảo thằng đang đăng nhập - admin sẽ không tự quản lý chính nó.
	// nghĩa là nó là đặc biệt nhất, ko cho nó tự xem nó trong list, mà phải xem trong profile
	// cái session này đang lưu thằng admin
